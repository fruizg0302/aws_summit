...
class AwardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create award" do
    assert_difference('Award.count') do
      post awards_url, params: { award: { answer_1: @award.answer_1, answer_2: @award.answer_2, answer_3: @award.answer_3, answer_4: @award.answer_4, answer_5: @award.answer_5, contact_email: @award.contact_email } }
    end
  ...
  test "should update award" do
    patch award_url(@award), params: { award: { answer_1: @award.answer_1, answer_2: @award.answer_2, answer_3: @award.answer_3, answer_4: @award.answer_4, answer_5: @award.answer_5, contact_email: @award.contact_email } }
